...
Choose the `TARGET_DIR` and run installation xonsh:

From the main branch with latest python version:
...
From latest xonsh release with mostly tested python version:
